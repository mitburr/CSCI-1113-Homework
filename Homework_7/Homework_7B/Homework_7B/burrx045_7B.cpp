...
void gotoTown(creature& you)
{
    ...
    cout << you.getName() << " walks into town. Would you like to (r)est or leave (any other key)?";
    char rest;
    cin >> rest;
    if ( rest == 'r'){
        you.fullHealth();
        cout << "you wake up with a kink in your back" << endl;
    }
...
void creature::setTotalhp()
{
    totalhp = hp;
}

void creature::fullHealth()
{
    hp = totalhp;
}
